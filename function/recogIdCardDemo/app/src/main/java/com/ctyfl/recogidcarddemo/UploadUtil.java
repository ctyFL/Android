...
public class UploadUtil {
     ...
     * @param url
     */
    public static void HttpGetThread(final Map<String, String> paramsMap, final String url) {
     ...
     * @param url
     */
    public static void HttpPostThread(final Map<String, String> paramsMap, final String url) {
        Thread thread = new Thread() {
            @Override
            public void run() {
                super.run();
